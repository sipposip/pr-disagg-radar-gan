...
generated = np.load('data/generated_samples.npy')
real = np.load('data/real_samples.npy')
generated_rainfarm = np.load('data/generated_samples_rainfarm.npy')
...
np.save(f'log_spectral_distances_real_n{n_samples}.npy', dists_real)
np.save(f'log_spectral_distances_gen_n{n_samples}.npy', dists_gen)
np.save(f'log_spectral_distances_gen_rainfarm_n{n_samples}.npy', dists_gen_rainfarm)
np.save(f'log_spectral_distances_between_gen_real_n{n_samples}.npy', dists_between_gen_and_real)
np.save(f'log_spectral_distances_between_gen_rainfarm_real_n{n_samples}.npy', dists_between_gen_rainfarm_and_real)
