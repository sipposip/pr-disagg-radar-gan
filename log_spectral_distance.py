...
#
# np.save('/climstorage/sebastian/pr_disagg/data/sprectra_real.npy', spectra_real)
# np.save('/climstorage/sebastian/pr_disagg/data/sprectra_gen.npy', spectra_gen)
# spectra_real = np.load('/climstorage/sebastian/pr_disagg/data/sprectra_real.npy')
# spectra_gen = np.load('/climstorage/sebastian/pr_disagg/data/sprectra_gen.npy')
...
res = {'real':dists_real,'gen':dists_real,
       'between':dists_between_gen_and_real}
