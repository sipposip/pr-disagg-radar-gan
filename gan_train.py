...
def create_discriminator():
    ...
    cond_expanded = tf.keras.layers.Lambda(lambda x: tf.keras.backend.repeat_elements(x,rep=nhours,axis=1))(cond_expanded)
...
n_plot = 10
[X_real, cond_real] = generate_real_samples(n_plot)
